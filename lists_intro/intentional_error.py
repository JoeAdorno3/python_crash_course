# the goal of this program is to insert an index error into one of my python programs to test and see what happens. Rather than keeping the error inside of and then removing it from a seperate program I thought that I would copy an existing program over using Vim's split file_name mode and then work on it here for practice
...
# introducing the index error here, will comment it out later
# print(guest_list[4])
